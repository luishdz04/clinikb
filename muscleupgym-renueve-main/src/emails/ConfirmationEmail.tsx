          ...
          <Container className="bg-white border border-solid border-[#e0e0e0] rounded-lg mx-auto max-w-[600px] overflow-hidden">
            ...
            <Section className="px-[30px] pb-[30px]">
              ...
              <Text className="text-[#333333] text-[16px] leading-[1.6]">
                Estamos emocionados de tenerte como parte de nuestra comunidad fitness. Para finalizar tu registro y acceder a todos nuestros servicios, por favor confirma tu dirección de correo electrónico:
              </Text>
              ...
              <Link href={confirmationUrl} className="text-[#555555] text-[12px] break-all block mb-[20px]">
                {confirmationUrl}
              </Link>
              ...
              <Section className="bg-[#f8f8f8] rounded-[5px] my-[20px] p-[20px]">
                <Text className="text-black font-bold mt-0 mb-[10px] text-[16px]">
                  Como miembro de Muscle Up GYM disfrutarás de:
                </Text>
