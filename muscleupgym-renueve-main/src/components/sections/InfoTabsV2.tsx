...
const trainers = [
  ...
  {
    id: 2,
    name: 'Karla Flores Rendón',
    role: 'Entrenadora personal',
    avatar: '/images/logocircular.png',
    bio: 'Especialista en entrenamiento funcional y acondicionamiento físico. Apasionada por ayudar a cada persona a alcanzar sus metas.',
    tags: ['Funcional', 'Acondicionamiento', 'Nutrición'],
    experience: '4 años',
    certifications: ['Certificación en Fitness']
  },
  {
    id: 3,
    name: 'Oromi',
    role: 'Entrenadora personal',
    avatar: '/images/logocircular.png',
    bio: 'Entrenadora dedicada con enfoque en bienestar integral y desarrollo de hábitos saludables.',
    tags: ['Wellness', 'Entrenamiento personalizado'],
    experience: '3 años',
    certifications: ['Certificación en Fitness']
  },
];
...
// Componente para cada tarjeta de horario con efectos mejorados
  ...
  return (
    <Card
      ...
      style={{
        ...
        border: `2px solid ${isToday ? colorTokens.primary : colorTokens.primaryBorder}`,
        borderRadius: '18px',
        padding: '36px 28px',
        minWidth: '210px',
        textAlign: 'center',
        ...
        position: 'relative',
        overflow: 'hidden',
        boxShadow: isToday ? `0 0 30px ${colorTokens.primary}40` : 'none',
    ...
    >
      ...
      <div style={{
        ...
        animation: isToday ? 'slideShine 3s infinite' : 'none'
      }} />
      ...
      <Space orientation="vertical" size="middle" style={{ width: '100%', position: 'relative', zIndex: 5 }}>
        <div style={{
          width: '56px',
          height: '56px',
          margin: '0 auto 16px',
          borderRadius: '14px',
          backgroundColor: isToday ? `${colorTokens.blackPure}20` : `${colorTokens.primary}20`,
          display: 'flex',
          alignItems: 'center',
...
// Componente para cada tarjeta de entrenador con efectos mejorados
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        right: 0,
        height: '6px',
        background: `linear-gradient(90deg, ${colorTokens.primary}, ${colorTokens.primaryLight}, ${colorTokens.primary})`,
        backgroundSize: '200% 100%',
        animation: 'gradientShift 3s ease infinite'
      }} />
      
      <Space orientation="vertical" size="large" style={{ width: '100%', textAlign: 'center', position: 'relative', zIndex: 5 }}>
        {/* Avatar con efectos */}
        <div
          style={{
            position: 'relative',
        ...
        >
          ...
          <div style={{
            ...
            inset: '-8px',
            borderRadius: '50%',
            background: `linear-gradient(45deg, ${colorTokens.primary}, transparent, ${colorTokens.primary})`,
          ...
          <div
            style={{
              ...
              boxShadow: `0 0 30px ${colorTokens.primaryShadow}`,
              zIndex: 10
            }}
...
export default function InfoTabsV2() {
      ...
      children: (
        <Space orientation="vertical" size="large" style={{ width: '100%' }}>
          ...
          <Row gutter={[20, 20]} justify="center">
            {schedule.map((item) => (
              <Col key={item.day} xs={24} sm={12} md={8} lg={6} xl={4}>
                <ScheduleCard
                  day={item.day}
                  hours={item.hours}
          ...
          <Alert
            title="⚠️ Entrada hasta 1 hora antes del cierre"
            type="warning"
            showIcon
            style={{
              marginTop: '32px',
